...
var minNum = document.querySelector('.game__min-num');
var maxNum = document.querySelector('.game__max-num');
var guessBtn = document.querySelector('#guess-submit');
var guessInput = document.querySelector('#guess-input');
var message = document.querySelector('.game__message');
